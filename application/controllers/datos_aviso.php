                         ...
                         //  print_r($this->session);
                          // $idaviso= $this->session->set_userdata('idaviso',$id_aviso);
                           // $data['idaviso']= array('value'=> $this->session->set_userdata('idaviso',$id_aviso),'name'=> 'idaviso','type'=>'hidden');
                            ...
                            $data['mes_reportado'] = array('value'=>$row_datos_informe->mes_reportado,'name'=>'mes_reportado','class'=>'requerido form-control','id'=>'mes_reportado','onchange'=>'mes_reportaedit()');
